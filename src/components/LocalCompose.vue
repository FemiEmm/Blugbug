...
<style scoped>
.compose-page{width:min(720px,calc(100% - 28px));margin:auto;padding:26px 0 90px}.compose-page>header{display:flex;align-items:center;gap:13px;padding:0 4px 18px}.compose-page>header>button{border:0;background:none;color:var(--cream);cursor:pointer}.compose-page>header>button:first-child{width:38px;height:38px;border:1px solid var(--line);border-radius:50%}.compose-page>header div{flex:1}.compose-page>header h1{margin:0;font-size:1.15rem}.compose-page>header p{margin:3px 0 0;color:var(--muted);font-size:.76rem}.compose-page>header .draft{color:var(--muted)}.compose-card{padding:20px;border:1px solid var(--line);border-radius:18px;background:var(--panel)}.author{display:flex;align-items:center;gap:10px;margin-bottom:18px}.author img{width:46px;height:46px;border-radius:50%;object-fit:cover}.author div{display:grid}.author span{color:var(--muted);font-size:.76rem}.author select{margin-left:auto;padding:8px 11px;border:1px solid var(--line);border-radius:999px;background:#111318;color:var(--cream);font-size:.76rem}.title{width:100%;padding:5px 0 14px;margin-bottom:14px;border:0;border-bottom:1px solid var(--line);background:none;color:#f5ede4;font:700 clamp(1.5rem,4vw,2.15rem)/1.2 Georgia,serif;outline:none}.title::placeholder{color:#626872}.preview{display:block;width:100%;max-height:340px;margin-top:14px;border:1px solid var(--line);border-radius:14px;object-fit:cover}.tools{display:flex;align-items:center;padding:13px 2px;border-bottom:1px solid var(--line);color:var(--muted);font-size:.78rem}.tools label{color:var(--orange);font-weight:800;cursor:pointer}.tools>span{margin-left:auto}.error{color:#ff806b;font-size:.82rem}.compose-card footer{display:flex;align-items:center;gap:20px;padding-top:14px}.compose-card footer p{flex:1;margin:0;color:var(--muted);font-size:.78rem}@media(max-width:540px){.compose-page{width:100%;padding-top:10px}.compose-page>header{padding:8px 12px 14px}.compose-card{border-left:0;border-right:0;border-radius:0;padding:16px}.author select{max-width:125px}.compose-card footer p{display:none}.compose-card footer button{width:100%}}
