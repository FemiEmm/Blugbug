...
export const throwIf = (error: any) => {
...
export const mapUser = (row: any): LocalUser => ({
  ...
  role: 'user',
  recovery_status: row.recovery_status || 'approved',
...
export const mapPost = (row: any): LocalPost => {
  ...
  return {
    ...
    chatter_name: author?.chatter_name,
    profile_image_url: author?.profile_image_url
  }
}
export const postSelect =
  '*,blugbug_users!blugbug_posts_user_id_fkey(full_name,chatter_name,profile_image_url),blugbug_topics(name)'
